 ...
 * as correct English (with Oxford comma, if applicable). Unless
 * conjunction is the empty string, in which case the list is simply
 * joined by ', '.
 ***********************************************************/
function englishJoin(list, conjunction = 'and') {
    if (list.length == 0 || conjunction === '') {
        return list.join(', ');
    } else {
